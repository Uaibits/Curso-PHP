...
<form action="<?= linkUrl('api/login')?>" method="post" style="background: honeydew; width: 50%; margin: 0 auto; padding: 25px">
    ...
    <a href="<?= urlBase('assets/imgs/upload/imagem.png')?>">Registrar</a>
</form>
